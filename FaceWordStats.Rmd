...
knitr::opts_chunk$set(warning = FALSE,
                      message = FALSE,
                      fig.width = 11)  # hide all warnings
knitr::opts_chunk$set()  # hide all messages
options(width = 450)
showAll = FALSE
```
...
##### Plot
```{r plots for functional scans E1 (anova) FFA, fig.asp = .75}
...
##### Plot
```{r plots for functional scans mvpa E1 (anova) FFA, fig.asp=0.5}

color_uni_E1_FFA <- sig_colors(one_mvpa_agg_E1_FFA$p)
...
plot_mvpa_E1_FFA <- {
  ggplot(data = one_mvpa_agg_E1_FFA, aes(y = mean, x = ClassifyPair, fill = ClassifyPair)) + # set the data, varialbes for x and y axises
    ...
    geom_text(label = signif(one_mvpa_agg_E1_FFA$p, 4), color = color_uni_E1_FFA, size = sig_size, nudge_y = 0.15) + # add starts to the significant columns
    general_theme +
...
##### Plot
```{r Similarity of top+bottom to intact vs. misconfigured in FFA, fig.asp=.55}
...
##### Plot
```{r plots for functional scans E1 (anova) FFA1, fig.asp = .75}
...
##### Plot
```{r plots for functional scans mvpa E1 (anova) FFA1, fig.asp=0.5}

color_uni_E1_FFA1 <- sig_colors(one_mvpa_agg_E1_FFA1$p)
...
plot_mvpa_E1_FFA1 <- {
  ggplot(data = one_mvpa_agg_E1_FFA1, aes(y = mean, x = ClassifyPair, fill = ClassifyPair)) + # set the data, varialbes for x and y axises
    ...
    geom_text(label = signif(one_mvpa_agg_E1_FFA1$p, 4), color = color_uni_E1_FFA1, size = sig_size, nudge_y = 0.15) + # add starts to the significant columns
    general_theme +
    theme(axis.title.x=element_blank(),
        axis.text.x=element_blank(),
        axis.ticks.x=element_blank(),
...
##### Plot
```{r plots for functional scans E1 (anova) FFA2, fig.asp = .75}
...
##### Plot
```{r plots for functional scans mvpa E1 (anova) FFA2, fig.asp=0.5}

color_uni_E1_FFA2 <- sig_colors(one_mvpa_agg_E1_FFA2$p)
...
plot_mvpa_E1_FFA2 <- {
  ggplot(data = one_mvpa_agg_E1_FFA2, aes(y = mean, x = ClassifyPair, fill = ClassifyPair)) + # set the data, varialbes for x and y axises
    ...
    geom_text(label = signif(one_mvpa_agg_E1_FFA2$p, 4), color = color_uni_E1_FFA2, size = sig_size, nudge_y = 0.15) + # add starts to the significant columns
    general_theme +
    theme(axis.title.x=element_blank(),
        axis.text.x=element_blank(),
        axis.ticks.x=element_blank(),
...
##### Plot
```{r plots for functional scans E1 (anova) VWFA, fig.asp = .45}
...
plot_uni_E1_VWFA <- {
  ggplot(data = as.data.frame(emm_anova_E1_VWFA), aes(y = emmean, x = FaceWord, fill = Layout)) + # set the data, varialbes for x and y axises
    ...
    geom_errorbar(mapping = aes(ymin = lower.CL, ymax = upper.CL), linetype = 1,  # set the error bar
                  ...
                  position = position_dodge(width=0.9)) +
    scale_y_continuous(expand= c(0, 0), limits = c(0, activationUL), breaks = seq(0, 3, .5)) +  # remove the space between columns and x axis
    labs(title = "Mean neural responses in VWFA (Univariate)", x = "Stimuli", y = "Beta values") +  # set the names for main, x and y axises 
...
##### Plot
```{r plots for functional scans mvpa E1 (anova) VWFA, fig.asp=0.5}

color_uni_E1_VWFA <- sig_colors(one_mvpa_agg_E1_VWFA$p)
...
plot_mvpa_E1_VWFA <- {
  ggplot(data = one_mvpa_agg_E1_VWFA, aes(y = mean, x = ClassifyPair, fill = ClassifyPair)) + # set the data, varialbes for x and y axises
    ...
    geom_text(label = signif(one_mvpa_agg_E1_VWFA$p, 4), color = color_uni_E1_VWFA, size = sig_size, nudge_y = 0.15) + # add starts to the significant columns
    general_theme +
    theme(axis.title.x=element_blank(),
        axis.text.x=element_blank(),
        axis.ticks.x=element_blank(),
...
##### Plot
```{r plots for functional scans E1 (anova) LOC, fig.asp = .75}
...
##### Plot
```{r plots for functional scans mvpa E1 (anova) LOC, fig.asp=0.5}

color_uni_E1_LOC <- sig_colors(one_mvpa_agg_E1_LOC$p)
...
plot_mvpa_E1_LOC <- {
  ggplot(data = one_mvpa_agg_E1_LOC, aes(y = mean, x = ClassifyPair, fill = ClassifyPair)) + # set the data, varialbes for x and y axises
    ...
    geom_text(label = signif(one_mvpa_agg_E1_LOC$p, 4), color = color_uni_E1_LOC, size = sig_size, nudge_y = 0.15) + # add starts to the significant columns
    general_theme +
    theme(axis.title.x=element_blank(),
        axis.text.x=element_blank(),
        axis.ticks.x=element_blank(),
...
##### Plot
```{r plots for functional scans E2 (anova) FFA, fig.asp = .75}
...
##### Plot
```{r plots for functional scans mvpa E2 (anova) FFA, fig.asp=0.5}

color_uni_E2_FFA <- sig_colors(one_mvpa_agg_E2_FFA$p)
...
plot_mvpa_E2_FFA <- {
  ggplot(data = one_mvpa_agg_E2_FFA, aes(y = mean, x = ClassifyPair, fill = ClassifyPair)) + # set the data, varialbes for x and y axises
    ...
    scale_x_discrete(labels = function(x) str_wrap(x, width = 10)) + # show x labels in two rows
    labs(title = "Decoding Accuracy in FFA", x = "Classification Pairs", y = "Accuracy") +  # set the names for main, x and y axises 
    geom_text(label = signif(one_mvpa_agg_E2_FFA$p, 4), color = color_uni_E2_FFA, size = sig_size, nudge_y = 0.15) + # add starts to the significant columns
    general_theme +
    theme(axis.title.x=element_blank(),
        axis.text.x=element_blank(),
        axis.ticks.x=element_blank(),
...
##### Plot
```{r plots for functional scans E2 (anova) FFA1, fig.asp = .75}
...
##### Plot
```{r plots for functional scans mvpa E2 (anova) FFA1, fig.asp=0.5}

color_uni_E2_FFA1 <- sig_colors(one_mvpa_agg_E2_FFA1$p)
...
plot_mvpa_E2_FFA1 <- {
  ggplot(data = one_mvpa_agg_E2_FFA1, aes(y = mean, x = ClassifyPair, fill=ClassifyPair)) + # set the data, varialbes for x and y axises
    ...
    scale_x_discrete(labels = function(x) str_wrap(x, width = 10)) + # show x labels in two rows
    labs(title = "Decoding Accuracy in FFA1", x = "Classification Pairs", y = "Accuracy") +  # set the names for main, x and y axises 
    geom_text(label = signif(one_mvpa_agg_E2_FFA1$p), color = color_uni_E2_FFA1, size = sig_size, nudge_y = 0.15) + # add starts to the significant columns
    general_theme +
    theme(axis.title.x=element_blank(),
        axis.text.x=element_blank(),
        axis.ticks.x=element_blank(),
...
##### Plot
```{r plots for functional scans E2 (anova) FFA2, fig.asp = .75}
...
##### Plot
```{r plots for functional scans mvpa E2 (anova) FFA2, fig.asp=0.5}

color_uni_E2_FFA2 <- sig_colors(one_mvpa_agg_E2_FFA2$p)
...
plot_mvpa_E2_FFA2 <- {
  ggplot(data = one_mvpa_agg_E2_FFA2, aes(y = mean, x = ClassifyPair, fill = ClassifyPair)) + # set the data, varialbes for x and y axises
    ...
    scale_x_discrete(labels = function(x) str_wrap(x, width = 10)) + # show x labels in two rows
    labs(title = "Decoding Accuracy in FFA2", x = "Classification Pairs", y = "Accuracy") +  # set the names for main, x and y axises Subjective Responses for E205
    geom_text(label = signif(one_mvpa_agg_E2_FFA2$p), color = color_uni_E2_FFA2, size = sig_size, nudge_y = 0.15) + # add starts to the significant columns
    general_theme +
    theme(axis.title.x=element_blank(),
        axis.text.x=element_blank(),
        axis.ticks.x=element_blank(),
...
##### Plot
```{r plots for functional scans E2 (anova) VWFA, fig.asp = .45}
...
##### Plot
```{r plots for functional scans mvpa E2 (anova) VWFA, fig.asp=0.5}

color_uni_E2_VWFA <- sig_colors(one_mvpa_agg_E2_VWFA$p)
...
plot_mvpa_E2_VWFA <- {
  ggplot(data = one_mvpa_agg_E2_VWFA, aes(y = mean, x = ClassifyPair, fill = ClassifyPair)) + # set the data, varialbes for x and y axises
    ...
    geom_text(label = signif(one_mvpa_agg_E2_VWFA$p, 4), color = color_uni_E2_VWFA, size = sig_size, nudge_y = 0.15) + # add starts to the significant columns
    general_theme +
    theme(axis.title.x=element_blank(),
        axis.text.x=element_blank(),
        axis.ticks.x=element_blank(),
...
##### Plot
```{r plots for functional scans E2 (anova) LOC, fig.asp = .75}
...
##### Plot
```{r plots for functional scans mvpa E2 (anova) LOC, fig.asp=0.5}

color_uni_E2_LOC <- sig_colors(one_mvpa_agg_E2_LOC$p)
...
plot_mvpa_E2_LOC <- {
  ggplot(data = one_mvpa_agg_E2_LOC, aes(y = mean, x = ClassifyPair, fill = ClassifyPair)) + # set the data, varialbes for x and y axises
    ...
    geom_text(label = signif(one_mvpa_agg_E2_LOC$p, 4), color = color_uni_E2_LOC, size = sig_size, nudge_y = 0.15) + # add starts to the significant columns
    general_theme +
    theme(axis.title.x=element_blank(),
        axis.text.x=element_blank(),
        axis.ticks.x=element_blank(),
