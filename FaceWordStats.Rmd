...
plot_intact_all <- ggplot(df_intact, aes(y = mean, x = ROI)) +
  ...
  facet_grid(Stimuli ~ Hemisphere, scales = "free_x", space = "free_x", labeller = labeller(Hemisphere = c(left = "left hemisphere", right = "right hemisphere"))) +
  ...
  theme(
    ...
    strip.text = element_text(size = 15), # element_blank(),
    strip.background = element_blank(),
    strip.placement = "outside",
  ) +
  NULL

# ggsave('plot_decode_all_intact.png', plot_intact_all, width = 9, height = 7)
...
plot_inex_all <- ggplot(df_inex, aes(y = mean, x = ROI)) +
  geom_col(position = "dodge", width = .5, fill = "#CDCDC8") +
  facet_grid(Exp + Stimuli ~ Hemisphere, scales = "free_x", space = "free_x", labeller = labeller(Hemisphere = c(left = "left hemisphere", right = "right hemisphere"))) +
  geom_errorbar(mapping = aes(ymin = lower.CL, ymax = upper.CL), linetype = 1,  # set the error bar
                show.legend = FALSE, width = 0.25, alpha = .5,
                position = position_dodge(width=0.9)) +
  geom_hline(yintercept = 0.5, linetype = 5, alpha = 0.5) +  # add the line for 0.5 and 1 (y)
...
# ggsave('plot_decode_all_inex.png', plot_inex_all, width = 8, height = 7)
plot_inex_all
```
...
# ggsave('plot_decode_all_topbottom.pdf', plot_topbottom_all, width = 8, height = 7)
plot_topbottom_all
```
