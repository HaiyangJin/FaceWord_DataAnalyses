...
df_decode_E1 <- read_csv(file.path("data", "faceword_E1_Decode_zscore.csv"))
...
df_simi <- read_csv(file.path("data", "faceword_E1_Similarity_zscore.csv"))
...
df_decode_E2 <- read_csv(file.path("data", "faceword_E2_Decode_zscore.csv"))
...
df_simi_E2 <- read_csv(file.path("data", "faceword_E2_Similarity_zscore.csv"))
