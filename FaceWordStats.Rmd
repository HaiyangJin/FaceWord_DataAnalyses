...
## For VSS2021
```{r}
vss_colors <- c("#1107F5", "#726DF5", "#E7ED4E", "#EAEC94", "#75FB4C", "#B1FC9A", "#D030E2", "#D989E3")
```

```{r fig.width=5, fig.asp=.618}
vssplot_uni_ie_E1 <- ggplot(df_uni_ie_1, aes(y = emmean, x = ROI, fill = interaction(ROI, Layout, sep="-", lex.order = T))) +
  geom_col(position = "dodge", width = .5) + # , fill = "#CDCDC8"
  ...
  geom_errorbar(mapping = aes(ymin = lower.CL, ymax = upper.CL), linetype = 1,  # set the error bar
                ...
                position = position_dodge(width=0.5)) +
  coord_cartesian(ylim = c(0, activationUL)) +
  labs(x = "ROIs", y = "Beta values") +  # set the names for main, x and y axis
  geom_text(aes(label = sig_ast(p.value)), size = 7, nudge_y = 0.65) + # add starts to the significant columns
  theme_bw() +
  theme(
    plot.title = element_text(lineheight=.8, face="bold", size = 24, hjust = 0.5, vjust = -1),
...
ggsave("vss_plot_uni_ie_E1.pdf", vssplot_uni_ie_E1, width = 11, height=11*.7)
```


```{r fig.width=5, fig.asp=.618}
vssplot_uni_tb_E1 <- ggplot(df_uni_tb_1, aes(y = emmean, x = ROI, fill = interaction(ROI, Layout, sep="-", lex.order = T))) +
  geom_col(position = "dodge", width = .5) + # , fill = "#CDCDC8"
  scale_fill_manual(values = vss_colors) +
  facet_grid(Stimuli ~ Hemisphere, scales = "free_x", space = "free_x",
             switch = "x",
...
ggsave("vss_plot_uni_tb_E1.pdf", vssplot_uni_tb_E1, width = 11, height=11*.7)
```

```{r fig.width=5, fig.asp=.618}
vssplot_uni_ie_E2 <- ggplot(df_uni_ie_2, aes(y = emmean, x = ROI, fill = interaction(ROI, Layout, sep="-", lex.order = T))) +
  geom_col(position = "dodge", width = .5) + # , fill = "#CDCDC8"
  scale_fill_manual(values = vss_colors) +
  facet_grid(Stimuli ~ Hemisphere, scales = "free_x", space = "free_x",
             switch = "x",
...
ggsave("vss_plot_uni_ie_E2.pdf", vssplot_uni_ie_E2, width = 11, height=11*.7)
```


```{r fig.width=5, fig.asp=.618}
vssplot_uni_tb_E2 <- ggplot(df_uni_tb_2, aes(y = emmean, x = ROI, fill = interaction(ROI, Layout, sep="-", lex.order = T))) +
  geom_col(position = "dodge", width = .5) + # , fill = "#CDCDC8"
  scale_fill_manual(values = vss_colors) +
  facet_grid(Stimuli ~ Hemisphere, scales = "free_x", space = "free_x",
             switch = "x",
...
ggsave("vss_plot_uni_tb_E2.pdf", vssplot_uni_tb_E2, width = 11, height=11*.7)
```

```{r fig.width=5, fig.asp=.618}
vssplot_uni_ie_E1_vlegend <- ggplot(df_uni_ie_1, aes(y = emmean, x = ROI, fill = interaction(ROI, Layout, sep="-", lex.order = T))) +
  geom_col(position = "dodge", width = .5) + # , fill = "#CDCDC8"
  scale_fill_manual(values = vss_colors) +
  facet_grid(Stimuli ~ Hemisphere, scales = "free_x", space = "free_x",
             switch = "x",
...
ggsave("vss_plot_uni_ie_E1_vlengend.pdf", vssplot_uni_ie_E1_vlegend, width = 11, height=11*.7)
```

```{r fig.width=5, fig.asp=.618}
vssplot_uni_tb_E1_vlegend <- ggplot(df_uni_tb_1, aes(y = emmean, x = ROI, fill = interaction(ROI, Layout, sep="-", lex.order = T))) +
  geom_col(position = "dodge", width = .5) + # , fill = "#CDCDC8"
  scale_fill_manual(values = vss_colors) +
  facet_grid(Stimuli ~ Hemisphere, scales = "free_x", space = "free_x",
             switch = "x",
...
ggsave("vss_plot_uni_tb_E1_vlengend.pdf", vssplot_uni_tb_E1_vlegend, width = 11, height=11*.7)
```
