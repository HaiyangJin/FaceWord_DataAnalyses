...
# Introduction
## Usage of this file
This file serves to be a supplementary document that describes all the statistics results performed for this project. It may help to test some new hypothses, which are not included in the corresponding slides. [Please refers to the slides for the hypotheses of this project.] 

## Experiment designs
This file displays the results of the FaceWord project (data collected at NYU). There are two experiments in this project. In Experiment 1, Chinese participants viewed Chinese faces and characters in four conditions (Layout: intact, misconfigured [top and bottom parts were switched], top and bottom) and completed an additional localizer (Chinese faces, Chinese characters, objects, scrambled objects). In Experiment 2, English speakers viewed Chinese characters and English words in four conditions (Layout: intact, misconfigured, top and bottom) and completed an additional localizer (Caucasian faces, English words, top [left two letters] and bottom [right four letters]).
...
2. Multivariate pattern analysis (MVPA) with libsvm is used to decode different condition pairs (see below) and one-tail one-sample t-tests is used to test if the pair of conditions can be decoded [accuracy is significantly larger than the chancel level (0.5)].
    + Pairs in E1: 
...
The probability was calculated individually:
...
3. The trained model is used to predict the probability of the combined pattern being misconfigured [for each run separately]. 
...
```
The above table displays the size (in mm2) of each label for each participant. (NA denotes there is no this label for that particiapnt.)
...
plot_simi_E1_FFA <- {
  ggplot(data = one_simi_E1_FFA, aes(y = mean, x = Combination, fill = Combination)) + # set the data, varialbes for x and y axises
    ...
    geom_text(label = signif(one_simi_E1_FFA$p), color = sig_colors(one_simi_E1_FFA$p), size = sig_size, nudge_y = 0.25) + # add starts to the significant columns
    general_theme +
    theme(axis.title.x=element_blank(),
        axis.text.x=element_blank(),
        axis.ticks.x=element_blank(),
...
plot_simi_E1_FFA2 <- {
  ggplot(data = one_simi_E1_FFA2, aes(y = mean, x = Combination, fill = Combination)) + # set the data, varialbes for x and y axises
    ...
    geom_text(label = signif(one_simi_E1_FFA2$p), color = sig_colors(one_simi_E1_FFA2$p), size = sig_size, nudge_y = 0.25) + # add starts to the significant columns
    general_theme +
    theme(axis.title.x=element_blank(),
        axis.text.x=element_blank(),
        axis.ticks.x=element_blank(),
...
plot_simi_E1_VWFA <- {
  ggplot(data = one_simi_E1_VWFA, aes(y = mean, x = Combination, fill = Combination)) + # set the data, varialbes for x and y axises
    ...
    geom_text(label = signif(one_simi_E1_VWFA$p), color = sig_colors(one_simi_E1_VWFA$p), size = sig_size, nudge_y = 0.25) + # add starts to the significant columns
    general_theme +
    theme(axis.title.x=element_blank(),
        axis.text.x=element_blank(),
        axis.ticks.x=element_blank(),
...
plot_simi_E1_LOC <- {
  ggplot(data = one_simi_E1_LOC, aes(y = mean, x = Combination, fill = Combination)) + # set the data, varialbes for x and y axises
    ...
    geom_text(label = signif(one_simi_E1_LOC$p), color = sig_colors(one_simi_E1_LOC$p), size = sig_size, nudge_y = 0.25) + # add starts to the significant columns
    general_theme +
    theme(axis.title.x=element_blank(),
        axis.text.x=element_blank(),
        axis.ticks.x=element_blank(),
...
plot_simi_E2_FFA <- {
  ggplot(data = one_simi_E2_FFA, aes(y = mean, x = Combination, fill = Combination)) + # set the data, varialbes for x and y axises
    ...
    # scale_x_discrete(labels = function(x) str_wrap(x, width = 10)) + # show x labels in two rows
    labs(title = "Similarity of top+bottom to intact vs. misconfigured in FFA", x = "Combinations", y = "Rate of Decoding as Misconfigured") +  # set the names for main, x and y axises
    geom_text(label = signif(one_simi_E2_FFA$p), color = sig_colors(one_simi_E2_FFA$p), size = sig_size, nudge_y = 0.25) + # add starts to the significant columns
    general_theme +
    theme(axis.title.x=element_blank(),
        axis.text.x=element_blank(),
        axis.ticks.x=element_blank(),
...
plot_simi_E2_FFA1 <- {
  ggplot(data = one_simi_E2_FFA1, aes(y = mean, x = Combination, fill = Combination)) + # set the data, varialbes for x and y axises
    ...
    geom_text(label = signif(one_simi_E2_FFA1$p), color = sig_colors(one_simi_E2_FFA1$p), size = sig_size, nudge_y = 0.25) + # add starts to the significant columns
    general_theme +
    theme(axis.title.x=element_blank(),
        axis.text.x=element_blank(),
        axis.ticks.x=element_blank(),
...
plot_simi_E2_FFA2 <- {
  ggplot(data = one_simi_E2_FFA2, aes(y = mean, x = Combination, fill = Combination)) + # set the data, varialbes for x and y axises
    ...
    # scale_x_discrete(labels = function(x) str_wrap(x, width = 10)) + # show x labels in two rows
    labs(title = "Similarity of top+bottom to intact vs. misconfigured in FFA2", x = "Combinations", y = "Rate of Decoding as Misconfigured") +  # set the names for main, x and y axises
    geom_text(label = signif(one_simi_E2_FFA2$p), color = sig_colors(one_simi_E2_FFA2$p), size = sig_size, nudge_y = 0.25) + # add starts to the significant columns
    general_theme +
    theme(axis.title.x=element_blank(),
        axis.text.x=element_blank(),
        axis.ticks.x=element_blank(),
...
plot_simi_E2_VWFA <- {
  ggplot(data = one_simi_E2_VWFA, aes(y = mean, x = Combination, fill = Combination)) + # set the data, varialbes for x and y axises
    ...
    # scale_x_discrete(labels = function(x) str_wrap(x, width = 10)) + # show x labels in two rows
    labs(title = "Similarity of top+bottom to intact vs. misconfigured in VWFA", x = "Combinations", y = "Rate of Decoding as Misconfigured") +  # set the names for main, x and y axises
    geom_text(label = signif(one_simi_E2_VWFA$p), color = sig_colors(one_simi_E2_VWFA$p), size = sig_size, nudge_y = 0.25) + # add starts to the significant columns
    general_theme +
    theme(axis.title.x=element_blank(),
        axis.text.x=element_blank(),
        axis.ticks.x=element_blank(),
...
plot_simi_E2_LOC <- {
  ggplot(data = one_simi_E2_LOC, aes(y = mean, x = Combination, fill = Combination)) + # set the data, varialbes for x and y axises
    ...
    # scale_x_discrete(labels = function(x) str_wrap(x, width = 10)) + # show x labels in two rows
    labs(title = "Similarity of top+bottom to intact vs. misconfigured in LOC", x = "Combinations", y = "Rate of Decoding as Misconfigured") +  # set the names for main, x and y axises
    geom_text(label = signif(one_simi_E2_LOC$p), color = sig_colors(one_simi_E2_LOC$p), size = sig_size, nudge_y = 0.25) + # add starts to the significant columns
    general_theme +
    theme(axis.title.x=element_blank(),
        axis.text.x=element_blank(),
        axis.ticks.x=element_blank(),
