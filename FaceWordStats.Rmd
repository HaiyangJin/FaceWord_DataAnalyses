...
```{r}
anova_E1_lFFA1_22 <- aov_4(Response ~ FaceWord * Layout + (FaceWord * Layout | SubjCode), 
                        data = filter(df_uni_E1_FFA1, 
                                      Label == label_FFA1[[1]],
                                      Layout %in% c("intact", "exchange")))
anova(anova_E1_lFFA1_22, "pes")
```
...
```{r}
anova_E1_rFFA1_22 <- aov_4(Response ~ FaceWord * Layout + (FaceWord * Layout | SubjCode), 
                        data = filter(df_uni_E1_FFA1, 
                                      Label == label_FFA1[[2]],
                                      Layout %in% c("intact", "exchange")))
anova(anova_E1_rFFA1_22, "pes")
```

```{r}
emm_aov_E1_rFFA1_22 <- emmeans(anova_E1_rFFA1_22, ~ FaceWord + Layout) 
contrast(emm_aov_E1_rFFA1_22, interaction = "pairwise")
```
...
2(face vs. word)$\times$2(intact vs. exchange) ANOVA
```{r}
anova_E1_lFFA2_22 <- aov_4(Response ~ FaceWord * Layout + (FaceWord * Layout | SubjCode), 
                        data = filter(df_uni_E1_FFA2, 
                                      Label == label_FFA2[[1]],
                                      Layout %in% c("intact", "exchange")))
anova(anova_E1_lFFA2_22, "pes")
```
...
2(face vs. word)$\times$2(intact vs. exchange) ANOVA
```{r}
anova_E1_rFFA2_22 <- aov_4(Response ~ FaceWord * Layout + (FaceWord * Layout | SubjCode), 
                        data = filter(df_uni_E1_FFA2, 
                                      Label == label_FFA2[[2]],
                                      Layout %in% c("intact", "exchange")))
anova(anova_E1_rFFA2_22, "pes")
```
...
2(face vs. word)$\times$2(intact vs. exchange) ANOVA
```{r}
anova_E1_VWFA_22 <- aov_4(Response ~ FaceWord * Layout + (FaceWord * Layout | SubjCode), 
                        data = filter(df_uni_E1_VWFA, 
                                      Label == label_VWFA[[1]],
                                      Layout %in% c("intact", "exchange")))
anova(anova_E1_VWFA_22, "pes")
```
...
2(face vs. word)$\times$2(intact vs. exchange) ANOVA
```{r}
anova_E1_lLO_22 <- aov_4(Response ~ FaceWord * Layout + (FaceWord * Layout | SubjCode), 
                        data = filter(df_uni_E1_LO, 
                                      Label == label_LO[[1]],
                                      Layout %in% c("intact", "exchange")))
anova(anova_E1_lLO_22, "pes")
```
...
2(face vs. word)$\times$2(intact vs. exchange) ANOVA
```{r}
anova_E1_rLO_22 <- aov_4(Response ~ FaceWord * Layout + (FaceWord * Layout | SubjCode), 
                        data = filter(df_uni_E1_LO, 
                                      Label == label_LO[[2]],
                                      Layout %in% c("intact", "exchange")))
anova(anova_E1_rLO_22, "pes")
```
...
2(face vs. word)$\times$2(intact vs. exchange) ANOVA
```{r}
anova_E2_lFFA1_22 <- aov_4(Response ~ FaceWord * Layout + (FaceWord * Layout | SubjCode), 
                        data = filter(df_uni_E2_FFA1, 
                                      Label == label_FFA1[[1]],
                                      Layout %in% c("intact", "exchange")))
anova(anova_E2_lFFA1_22, "pes")
```
...
2(face vs. word)$\times$2(intact vs. exchange) ANOVA
```{r}
anova_E2_rFFA1_22 <- aov_4(Response ~ FaceWord * Layout + (FaceWord * Layout | SubjCode), 
                        data = filter(df_uni_E2_FFA1, 
                                      Label == label_FFA1[[2]],
                                      Layout %in% c("intact", "exchange")))
anova(anova_E2_rFFA1_22, "pes")
```
...
2(face vs. word)$\times$2(intact vs. exchange) ANOVA
```{r}
anova_E2_lFFA2_22 <- aov_4(Response ~ FaceWord * Layout + (FaceWord * Layout | SubjCode), 
                        data = filter(df_uni_E2_FFA2, 
                                      Label == label_FFA2[[1]],
                                      Layout %in% c("intact", "exchange")))
anova(anova_E2_lFFA2_22, "pes")
```
...
2(face vs. word)$\times$2(intact vs. exchange) ANOVA
```{r}
anova_E2_rFFA2_22 <- aov_4(Response ~ FaceWord * Layout + (FaceWord * Layout | SubjCode), 
                        data = filter(df_uni_E2_FFA2, 
                                      Label == label_FFA2[[2]],
                                      Layout %in% c("intact", "exchange")))
anova(anova_E2_rFFA2_22, "pes")
```
...
2(face vs. word)$\times$2(intact vs. exchange) ANOVA
```{r}
anova_E2_VWFA_22 <- aov_4(Response ~ FaceWord * Layout + (FaceWord * Layout | SubjCode), 
                        data = filter(df_uni_E2_VWFA, 
                                      Label == label_VWFA[[1]],
                                      Layout %in% c("intact", "exchange")))
anova(anova_E2_VWFA_22, "pes")
```
...
2(face vs. word)$\times$2(intact vs. exchange) ANOVA
```{r}
anova_E2_lLO_22 <- aov_4(Response ~ FaceWord * Layout + (FaceWord * Layout | SubjCode), 
                        data = filter(df_uni_E2_LO, 
                                      Label == label_LO[[1]],
                                      Layout %in% c("intact", "exchange")))
anova(anova_E2_lLO_22, "pes")
```
...
2(face vs. word)$\times$2(intact vs. exchange) ANOVA
```{r}
anova_E2_rLO_22 <- aov_4(Response ~ FaceWord * Layout + (FaceWord * Layout | SubjCode), 
                        data = filter(df_uni_E2_LO, 
                                      Label == label_LO[[2]],
                                      Layout %in% c("intact", "exchange")))
anova(anova_E2_rLO_22, "pes")
```
