...
df_decode_E1 <- read_csv(file.path("data", "faceword_E1_Decode_HJ.csv"))
...
df_simi <- read_csv(file.path("data", "faceword_E1_similarity_HJ.csv"))
...
df_decode_E2 <- read_csv(file.path("data", "faceword_E2_Decode_HJ.csv"))
...
df_simi_E2 <- read_csv(file.path("data", "faceword_E2_similarity_HJ.csv"))
...
df_LO_area_E1 <- read_csv(file.path("data", "faceword_E1_Decode_LO_zscore.csv")) %>% 
  select(Label, SessCode, ClassifyPair, ACC) %>% 
  mutate(Hemisphere = if_else(grepl("lh", Label), "left", 
                              if_else(grepl("rh", Label), "right", "NA")),
         Subject = str_remove(SessCode, "\\_.*")) %>% 
...
```{r}
# load decoding results in LO
df_LO_area_E2 <- read_csv(file.path("data", "faceword_E2_Decode_LO_zscore.csv")) %>% 
  select(Label, SessCode, ClassifyPair, ACC) %>% 
  mutate(Hemisphere = if_else(grepl("lh", Label), "left", 
                              if_else(grepl("rh", Label), "right", "NA")),
         Subject = str_remove(SessCode, "\\_.*"),
...
dat_text_intact_LO_area <- data.frame(
  Stimuli = c("faces\nvs.\nwords", "English\nvs.\nChinese"),
  Hemisphere = c("left"),
  label = c("faces vs. words", "English vs. Chinese"),
  x     = c(1.35, 1.6),
  y     = 1.05
)
...
plot_intact_LO_area <- ggplot(df_intact_LO_area, aes(y = mean, x = Area)) +
  ...
  labs(title = "Intact stimuli", x = expression(paste("Lateral Occipital Label Area (", mm^2, ")")), y = "Accuracy") +  # set the names for main, x and y axises
  ...
  geom_text(data = dat_text_intact_LO_area, aes(x = x, y = y, label = label), size = 5, fontface = "bold") + #
  theme_bw() +
  theme(
...
dat_text_inex_LO_area <- data.frame(
  ...
  Hemisphere = c("left"),
  label = levels(df_inex_LO_area$Stimuli),
  x     = c(1, 1.1, 1.2, 1.2),
  y     = 1.05
)
...
plot_inex_LO_area <- ggplot(df_inex_LO_area, aes(y = mean, x = Area)) +
  ...
  geom_text(aes(label = sig_ast(p)), size = 7, nudge_y = 0.15) + # add starts to the significant columns
  # geom_text(aes(label = round(mean, 2)), size = 4, nudge_y = 0.2) +
  geom_text(data = dat_text_inex_LO_area, mapping = aes(x = x, y = y, label = label), size = 6, fontface = "bold") +
  theme_bw() +
  theme(
    plot.title = element_text(lineheight=.8, face="bold", size = 24, hjust = 0.5, vjust = -1),
    # plot.margin = margin(5, 170, 60, 40, unit = "pt"),
...
dat_text_inex_LO_area_lr_fw <- data.frame(
  ...
  Hemisphere = "left",
  label = levels(df_inex_LO_area$Stimuli)[1:2],
  x     = c(1, 1.1),
  y     = 1.05
)
...
plot_inex_LO_area_E1 <- ggplot(filter(df_inex_LO_area, Exp == "E1"), aes(y = mean, x = Area)) +
  ...
  scale_y_continuous(expand= c(0, 0), breaks = seq(0, 1, .25)) +  # remove the space between columns and x axis
  coord_cartesian(ylim = c(0.4, 1.1)) +
  labs(title = "", x = expression(paste("Lateral Occipital Label Area (", mm^2, ")")), y = "Accuracy") +  # set the names for main, x and y axises Experiment 1
  geom_text(aes(label = sig_ast(p)), size = 7, nudge_y = 0.15) + # add starts to the significant columns
  # geom_text(aes(label = round(mean, 2)), size = 4, nudge_y = 0.2) +
  geom_text(data = dat_text_inex_LO_area_lr_fw, mapping = aes(x = x, y = y, label = label), size = 6, fontface = "bold") +
  theme_bw() +
  theme(
    plot.title = element_text(lineheight=.8, face="bold", size = 24, hjust = 0.5, vjust = -1),
    # plot.margin = margin(5, 170, 60, 40, unit = "pt"),
...
dat_text_inex_LO_area_lr_ec <- data.frame(
  ...
  Hemisphere = "left",
  label = levels(df_inex_LO_area$Stimuli)[3:4],
  x     = c(1.1, 1.2),
  y     = 1.05
)
...
plot_inex_LO_area_E2 <- ggplot(filter(df_inex_LO_area, Exp == "E2"), aes(y = mean, x = Area)) +
  ...
  scale_y_continuous(expand= c(0, 0), breaks = seq(0, 1, .25)) +  # remove the space between columns and x axis
  coord_cartesian(ylim = c(0.4, 1.1)) +
  labs(title = "", x = expression(paste("Lateral Occipital Label Area (", mm^2, ")")), y = "Accuracy") +  # set the names for main, x and y axises Experiment 2
  geom_text(aes(label = sig_ast(p)), size = 7, nudge_y = 0.15) + # add starts to the significant columns
  # geom_text(aes(label = round(mean, 2)), size = 4, nudge_y = 0.2) +
  geom_text(data = dat_text_inex_LO_area_lr_ec, mapping = aes(x = x, y = y, label = label), size = 6, fontface = "bold") +
  theme_bw() +
  theme(
    plot.title = element_text(lineheight=.8, face="bold", size = 24, hjust = 0.5, vjust = -1),
    # plot.margin = margin(5, 170, 60, 40, unit = "pt"),
...
dat_parts_inex_LO_area <- data.frame(
  ...
  Hemisphere = c("left"),
  label = levels(df_parts_LO_area$Stimuli),
  x     = c(1, 1.1, 1.2, 1.2),
  y     = 1.05
)
...
plot_topbottom_LO_area <- ggplot(df_parts_LO_area, aes(y = mean, x = Area)) +
  ...
  geom_text(aes(label = sig_ast(p)), size = 7, nudge_y = 0.15) + # add starts to the significant columns
  # geom_text(aes(label = round(mean, 2)), size = 4, nudge_y = 0.2) +
  geom_text(data = dat_parts_inex_LO_area, mapping = aes(x = x, y = y, label = label), size = 6, fontface = "bold") +
  theme_bw() +
  theme(
    plot.title = element_text(lineheight=.8, face="bold", size = 24, hjust = 0.5, vjust = -1),
    # plot.margin = margin(5, 170, 60, 40, unit = "pt"),
...
dat_text_tb_all_lr_E1 <- data.frame(
  ...
  Hemisphere = "left",
  label = levels(df_parts_LO_area$Stimuli)[1:2],
  x     = c(1, 1.1),
  y     = 1.05
)
...
plot_topbottom_LO_area_E1 <- ggplot(filter(df_parts_LO_area, Exp == "E1"), aes(y = mean, x = Area)) +
  ...
  geom_text(aes(label = sig_ast(p)), size = 7, nudge_y = 0.15) + # add starts to the significant columns
  # geom_text(aes(label = round(mean, 2)), size = 4, nudge_y = 0.2) +
  geom_text(data = dat_text_tb_all_lr_E1, mapping = aes(x = x, y = y, label = label), size = 6.5, fontface = "bold") +
  theme_bw() +
  theme(
    plot.title = element_text(lineheight=.8, face="bold", size = 24, hjust = 0.5, vjust = -1),
    # plot.margin = margin(5, 170, 60, 40, unit = "pt"),
...
dat_text_tb_all_lr_E2 <- data.frame(
  ...
  Hemisphere = "left",
  label = levels(df_parts_LO_area$Stimuli)[3:4],
  x     = c(1.1, 1.2),
  y     = 1.05
)
...
plot_topbottom_LO_area_E2 <- ggplot(filter(df_parts_LO_area, Exp == "E2"), aes(y = mean, x = Area)) +
  ...
  geom_text(aes(label = sig_ast(p)), size = 7, nudge_y = 0.15) + # add starts to the significant columns
  # geom_text(aes(label = round(mean, 2)), size = 4, nudge_y = 0.2) +
  geom_text(data = dat_text_tb_all_lr_E2, mapping = aes(x = x, y = y, label = label), size = 6.5, fontface = "bold") +
  theme_bw() +
  theme(
    plot.title = element_text(lineheight=.8, face="bold", size = 24, hjust = 0.5, vjust = -1),
    # plot.margin = margin(5, 170, 60, 40, unit = "pt"),
...
plot_intact_all <- ggplot(df_intact, aes(y = mean, x = ROI)) +
  ...
  scale_y_continuous(expand= c(0, 0), breaks = seq(0, 1, .25)) +  # remove the space between columns and x axis
  coord_cartesian(ylim = c(0.4, 1.1)) +
  labs(title = "Intact stimuli", x = "ROIs", y = "Accuracy") +  # set the names for main, x and y axises
  geom_text(aes(label = sig_ast(p)), size = 7, nudge_y = 0.15) + # add starts to the significant columns
  # geom_text(aes(label = round(mean, 2)), size = 4, nudge_y = 0.2) +
  geom_text(data = dat_text_intact_all, aes(x = x, y = y, label = label), size = 5, fontface = "bold") + #
  theme_bw() +
  theme(
    plot.title = element_text(lineheight=.8, face="bold", size = 24, hjust = 0.5, vjust = -1),
    # plot.margin = margin(5, 170, 60, 40, unit = "pt"),
...
# ggsave('plot_decode_all_intact.png', plot_intact_all, width = 8, height = 8)
plot_intact_all
```
...
plot_inex_all <- ggplot(df_inex, aes(y = mean, x = ROI)) +
  ...
  geom_text(aes(label = sig_ast(p)), size = 7, nudge_y = 0.15) + # add starts to the significant columns
  # geom_text(aes(label = round(mean, 2)), size = 4, nudge_y = 0.2) +
  geom_text(data = dat_text_inex_all, mapping = aes(x = x, y = y, label = label), size = 6, fontface = "bold") +
  theme_bw() +
  theme(
    plot.title = element_text(lineheight=.8, face="bold", size = 24, hjust = 0.5, vjust = -1),
    # plot.margin = margin(5, 170, 60, 40, unit = "pt"),
...
# ggsave('plot_decode_all_inex.png', plot_inex_all, width = 8, height = 16)
plot_inex_all
```
...
dat_text_inex_all_lr_fw <- data.frame(
  ...
  Hemisphere = "left",
  label = levels(df_inex$Stimuli)[1:2],
  x     = c(1, 1.1),
  y     = 1.05
)
...
plot_inex_E1 <- ggplot(filter(df_inex, Exp == "E1"), aes(y = mean, x = ROI)) +
  ...
  scale_y_continuous(expand= c(0, 0), breaks = seq(0, 1, .25)) +  # remove the space between columns and x axis
  coord_cartesian(ylim = c(0.4, 1.1)) +
  labs(title = "", x = "ROIs", y = "Accuracy") +  # set the names for main, x and y axises Experiment 1
  geom_text(aes(label = sig_ast(p)), size = 7, nudge_y = 0.15) + # add starts to the significant columns
  # geom_text(aes(label = round(mean, 2)), size = 4, nudge_y = 0.2) +
  geom_text(data = dat_text_inex_all_lr_fw, mapping = aes(x = x, y = y, label = label), size = 6, fontface = "bold") +
  theme_bw() +
  theme(
    plot.title = element_text(lineheight=.8, face="bold", size = 24, hjust = 0.5, vjust = -1),
    # plot.margin = margin(5, 170, 60, 40, unit = "pt"),
...
dat_text_inex_all_lr_ec <- data.frame(
  ...
  Hemisphere = "left",
  label = levels(df_inex$Stimuli)[3:4],
  x     = c(1.1, 1.2),
  y     = 1.05
)
...
plot_inex_E2 <- ggplot(filter(df_inex, Exp == "E2"), aes(y = mean, x = ROI)) +
  ...
  scale_y_continuous(expand= c(0, 0), breaks = seq(0, 1, .25)) +  # remove the space between columns and x axis
  coord_cartesian(ylim = c(0.4, 1.1)) +
  labs(title = "", x = "ROIs", y = "Accuracy") +  # set the names for main, x and y axises Experiment 2
  geom_text(aes(label = sig_ast(p)), size = 7, nudge_y = 0.15) + # add starts to the significant columns
  # geom_text(aes(label = round(mean, 2)), size = 4, nudge_y = 0.2) +
  geom_text(data = dat_text_inex_all_lr_ec, mapping = aes(x = x, y = y, label = label), size = 6, fontface = "bold") +
  theme_bw() +
  theme(
    plot.title = element_text(lineheight=.8, face="bold", size = 24, hjust = 0.5, vjust = -1),
    # plot.margin = margin(5, 170, 60, 40, unit = "pt"),
...
plot_topbottom_all <- ggplot(df_parts, aes(y = mean, x = ROI)) +
  ...
  geom_text(aes(label = sig_ast(p)), size = 7, nudge_y = 0.15) + # add starts to the significant columns
  # geom_text(aes(label = round(mean, 2)), size = 4, nudge_y = 0.2) +
  geom_text(data = dat_parts_inex_all, mapping = aes(x = x, y = y, label = label), size = 6, fontface = "bold") +
  theme_bw() +
  theme(
    plot.title = element_text(lineheight=.8, face="bold", size = 24, hjust = 0.5, vjust = -1),
    # plot.margin = margin(5, 170, 60, 40, unit = "pt"),
...
dat_text_tb_all_lr_E1 <- data.frame(
  ...
  Hemisphere = "left",
  label = levels(df_parts$Stimuli)[1:2],
  x     = c(1, 1.1),
  y     = 1.05
)
...
dat_text_tb_all_lr_E2 <- data.frame(
  ...
  Hemisphere = "left",
  label = levels(df_parts$Stimuli)[3:4],
  x     = c(1.1, 1.2),
  y     = 1.05
)
...
dat_text_inex_all <- data.frame(
  ...
  HemiROI = c("lFFA1"),
  label = levels(df_uni_ie$Stimuli),
  x     = c(1, 1.1, 1.2, 1.2),
  y     = 2.4
)
...
plot_uni_inex_all <- ggplot(df_uni_ie, aes(y = emmean, x = Layout)) +
  ...
  # geom_text(aes(label = round(mean, 2)), size = 4, nudge_y = 0.2) +
  geom_text(data = dat_text_inex_all, mapping = aes(x = x, y = y, label = label), size = 7, fontface = "bold") +
  theme_bw() +
  theme(
    plot.title = element_text(lineheight=.8, face="bold", size = 24, hjust = 0.5, vjust = -1),
    # plot.margin = margin(5, 170, 60, 40, unit = "pt"),
...
# ggsave('plot_uni_all_inex.png', plot_uni_inex_all, width = 8, height = 16)
plot_uni_inex_all
```
...
plot_uni_inex_all_ <- ggplot(df_uni_ie, aes(y = emmean, x = ROI, fill = Layout)) +
  ...
  # geom_text(aes(label = round(mean, 2)), size = 4, nudge_y = 0.2) +
  geom_text(data = dat_text_inex_all_, mapping = aes(x = x, y = y, label = label), size = 7, fontface = "bold") +
  theme_bw() +
  theme(
    plot.title = element_text(lineheight=.8, face="bold", size = 24, hjust = 0.5, vjust = -1),
...
dat_text_inex_all_lr1 <- data.frame(
  ...
  Hemisphere = "left",
  Layout = "intact",
  label = levels(df_uni_ie_1$Stimuli),
  x     = c(1, 1.1),
  y     = 2.4
)
...
plot_uni_inex_all_lr1 <- ggplot(df_uni_ie_1, aes(y = emmean, x = ROI, fill = Layout)) +
  ...
  # scale_y_continuous(expand= c(0, 0), breaks = seq(0, 1, .25)) +  # remove the space between columns and x axis
  coord_cartesian(ylim = c(0, activationUL)) +
  labs(title = "", x = "ROIs", y = "Beta values") +  # set the names for main, x and y axises
  geom_text(aes(label = sig_ast(p.value)), size = 7, nudge_y = 0.65) + # add starts to the significant columns
  # geom_text(aes(label = round(mean, 2)), size = 4, nudge_y = 0.2) +
  geom_text(data = dat_text_inex_all_lr1, mapping = aes(x = x, y = y, label = label), size = 7, fontface = "bold") +
  theme_bw() +
  theme(
    plot.title = element_text(lineheight=.8, face="bold", size = 24, hjust = 0.5, vjust = -1),
    text = element_text(colour="black", size = 18),
...
dat_text_inex_all_lr2 <- data.frame(
  ...
  Hemisphere = "left",
  Layout = "intact",
  label = levels(df_uni_ie_2$Stimuli),
  x     = c(1.1, 1.2),
  y     = 2.4
)
...
plot_uni_inex_all_lr2 <- ggplot(df_uni_ie_2, aes(y = emmean, x = ROI, fill = Layout)) +
  ...
  geom_text(aes(label = sig_ast(p.value)), size = 7, nudge_y = 0.65) + # add starts to the significant columns
  # geom_text(aes(label = round(mean, 2)), size = 4, nudge_y = 0.2) +
  geom_text(data = dat_text_inex_all_lr2, mapping = aes(x = x, y = y, label = label), size = 7, fontface = "bold") +
  theme_bw() +
  theme(
    plot.title = element_text(lineheight=.8, face="bold", size = 24, hjust = 0.5, vjust = -1),
    text = element_text(colour="black", size = 18),
...
# ggsave('plot_uni_all_ie_lr.png', plot_uni_ie_lr, width = 15, height = 9)
plot_uni_ie_lr
```
...
dat_text_inex_all <- data.frame(
  ...
  HemiROI = c("lFFA1"),
  label = levels(df_uni_tb$Stimuli),
  x     = c(1, 1.1, 1.2, 1.2),
  y     = 2.4
)
...
dat_text_inex_all_lr1 <- data.frame(
  ...
  Hemisphere = "left",
  Layout = "partA",
  label = levels(df_uni_tb_1$Stimuli),
  x     = c(1, 1.1),
  y     = 2.4
)
...
dat_text_inex_all_lr2 <- data.frame(
  ...
  Hemisphere = "left",
  Layout = "partA",
  label = levels(df_uni_tb_2$Stimuli),
  x     = c(1.1, 1.2),
  y     = 2.4
)
...
# ggsave('plot_uni_all_tb_lr.png', plot_uni_tb_lr, width = 15, height = 9)
plot_uni_tb_lr
```
