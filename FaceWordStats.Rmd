...
plot_uni_E1_FFA2 <- plot_uni(desp_uni_E1_FFA1, contr_aov_E1_lFFA1, contr_aov_E1_rFFA1, "FFA2")
...
desp_uni_E1_FFA2 <- cbind(Hemisphere, as.data.frame(emm_aov_E1_lFFA2))


plot_uni_E1_VWFA <- plot_uni_vwfa(desp_uni_E1_FFA2, contr_aov_E1_VWFA, "VWFA")
