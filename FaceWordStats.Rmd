...
fn_simi <- "Main_Similarity.csv"  # similarity of top+bottom to intact vs. exchange. 

# set the order of levels in factors
locOrder <- c("face", "object", "word", "scrambled")

facewordOrder <- c("faces", "words")
wordsOrder <- c("English", "Chinese")
...
df_clean_simi <- {
  df_simi %>% 
    mutate(
      asExchange = if_else(grepl("exchange", PredictCond), 1, 0),
      pExchange = Probability_2,
...
```{r rate of decoding as exchange, include=showAll}

df_rate_simi <- {
  df_clean_simi %>% 
    filter(nVertices >= nVtx_min) %>% # remove the label whose vertex number is smaller than nVtx_min
    group_by(ExpCode, SubjCode, Label, ClassPair_1, Combination) %>% 
    summarize(RateAsExchange = mean(asExchange),
...
##### Plot
```{r plots for functional scans E1 (anova) FFA, fig.asp = 0.75, fig.width = 8}

# sig_uni_E1_FFA <- rep(1, 1, 16)
# sig_uni_E1_FFA[seq(1, 16, 4)] <- c(signif(as.data.frame(contr_anova_E1_lFFA)[c(5, 11), "p.value"], nDigitals),
#                      signif(as.data.frame(contr_anova_E1_rFFA)[c(5, 11), "p.value"], nDigitals))
# ast_uni_E1_FFA <- sig_ast(sig_uni_E1_FFA)
...
# 
# plot_uni_E1_FFA <- {
#   ggplot(data = desp_uni_E1_FFA, aes(y = emmean, x = Layout, group = Hemisphere)) + # set the data, varialbes for x and y axises
#     geom_col(position = "dodge", width = 0.4, fill = "#CDCDC8") +  # position of columns and countour of columns
#     facet_grid(FaceWord ~ Hemisphere) +
#     geom_errorbar(mapping = aes(ymin = lower.CL, ymax = upper.CL), linetype = 1,  # set the error bar
#                   show.legend = FALSE, width = 0.2, alpha = .5,
#                   position = position_dodge(width=0.9)) +
#     scale_y_continuous(expand= c(0, 0), limits = c(0, activationUL), breaks = seq(0, 3, .5)) +  # remove the space between columns and x axis
#     labs(title = "Mean neural responses in FFA (Univariate)", x = "Configuration", y = "Beta values") +  # set the names for main, x and y axises
#     geom_text(label = ast_uni_E1_FFA, size = sig_size, nudge_y = 0.5, nudge_x = 0.5) + # add starts to the significant columns
#     general_theme
# }
...
plot_uni_E1_FFA <- plot_uni(desp_uni_E1_FFA, contr_anova_E1_lFFA, contr_anova_E1_rFFA, "FFA")

ggsave('plot_uni_E1_FFA.pdf', plot_uni_E1_FFA, width = 10, height = 10)

plot_uni_E1_FFA

```
The above figure shows the neural respones (beta values) in FFA for each condition. The numbers are the p-values for the tests of differences between intact vs. exchange in that condition. Error bars represent 95% confidence intervals.


```{r plots for functional scans E1 (anova) FFA (test example), fig.asp = .75, fig.width = 8}
...
plot_uni_E1_FFA.gray1 <- {
  ggplot(data = desp_uni_E1_FFA, aes(y = emmean, x = Layout, fill = Layout)) + # set the data, varialbes for x and y axises
    geom_col(position = position_dodge(width = 0.1), color = "black", alpha = .7, width = 0.5, show.legend = FALSE) +  # position of columns and countour of columns
    scale_fill_grey(4) +
    facet_grid(FaceWord ~ Hemisphere) +
    geom_errorbar(mapping = aes(ymin = lower.CL, ymax = upper.CL), linetype = 1,  # set the error bar
                  show.legend = FALSE, width = 0.25, alpha = .5,
                  position = position_dodge(width=0.9)) +
    scale_y_continuous(expand= c(0, 0), limits = c(0, activationUL), breaks = seq(0, 3, .5)) +  # remove the space between columns and x axis
    labs(title = "Mean neural responses in FFA (Univariate)", x = "Layout", y = "Beta values") +  # set the names for main, x and y axises 
    geom_text(label = sig_uni_E1_FFA, color = color_uni_E1_FFA, size = sig_size, nudge_y = 0.5, nudge_x = 0.5) + # add starts to the significant columns
    general_theme
}

ggsave('plot_uni_E1_FFA_1.pdf', plot_uni_E1_FFA.gray1, width = 10, height = 10)

```


```{r}
plot_uni_E1_FFA.gray2 <- {
  ggplot(data = desp_uni_E1_FFA, aes(y = emmean, x = Layout, fill = Layout)) + # set the data, varialbes for x and y axises
    geom_col(position = position_dodge(width = 0.1), color = "black", alpha = .7, fill = "grey", width = 0.5, show.legend = FALSE) +  # position of columns and countour of columns
    facet_grid(FaceWord ~ Hemisphere) +
    geom_errorbar(mapping = aes(ymin = lower.CL, ymax = upper.CL), linetype = 1,  # set the error bar
                  show.legend = FALSE, width = 0.25, alpha = .5,
                  position = position_dodge(width=0.9)) +
...
ggsave('plot_uni_E1_FFA_2.pdf', plot_uni_E1_FFA.gray2, width = 10, height = 10)

```


```{r}
plot_uni_E1_FFA.gray3 <- {
  ggplot(data = desp_uni_E1_FFA, aes(y = emmean, x = Layout, fill = Layout)) + # set the data, varialbes for x and y axises
    geom_col(position = position_dodge(width = 0.1), color = "black", alpha = .7, width = 1, show.legend = FALSE) +  # position of columns and countour of columns
    scale_fill_grey() +
    facet_grid(FaceWord ~ Hemisphere) +
    geom_errorbar(mapping = aes(ymin = lower.CL, ymax = upper.CL), linetype = 1,  # set the error bar
                  show.legend = FALSE, width = 0.25, alpha = .5,
...
ggsave('plot_uni_E1_FFA_3.pdf', plot_uni_E1_FFA.gray3, width = 7, height = 10)

```


```{r}
plot_uni_E1_FFA.gray4 <- {
  ggplot(data = desp_uni_E1_FFA, aes(y = emmean, x = Layout, fill = Layout)) + # set the data, varialbes for x and y axises
    geom_col(position = position_dodge(width = 0.1), color = "black", fill = "gray", alpha = .7, width = 1, show.legend = FALSE) +  # position of columns and countour of columns
    facet_grid(FaceWord ~ Hemisphere) +
    geom_errorbar(mapping = aes(ymin = lower.CL, ymax = upper.CL), linetype = 1,  # set the error bar
                  show.legend = FALSE, width = 0.25, alpha = .5,
                  position = position_dodge(width=0.9)) +
...
ggsave('plot_uni_E1_FFA_4.pdf', plot_uni_E1_FFA.gray4, width = 7, height = 10)
...
##### Plot
```{r plots for functional scans mvpa E1 (anova) FFA, fig.asp=1, fig.width = 9}
...
plot_mvpa_E1_FFA <- plot_mvpa(one_mvpa_agg_E1_FFA, "FFA")

# ggsave('plot_mvpa_E1_FFA.png', plot_mvpa_E1_FFA, width = 6, height = 10, units = "in")

ggsave('plot_mvpa_E1_FFA.pdf', plot_mvpa_E1_FFA, width = 6.5, height = 16, units = "in")
...
ggsave('plot_mvpa_E1_FFA_1.pdf', plot_mvpa_E1_FFA_1, width = 12, height = 5)
```

```{r}
plot_mvpa_E1_FFA_2 <- {
  ggplot(data = one_mvpa_agg_E1_FFA, aes(y = mean, x = ClassifyPair, fill = ClassifyPair)) + # set the data, varialbes for x and y axises
    geom_col(position = "dodge", color = "black", alpha = .7, show.legend = FALSE) +  # position of columns and countour of columns
    scale_fill_grey() +
    facet_grid(. ~ Hemisphere) +
    # scale_fill_manual(values = mvpaColors) +
    geom_errorbar(mapping = aes(ymin = lower.CL, ymax = upper.CL), linetype = 1,  # set the error bar
...
ggsave('plot_mvpa_E1_FFA_2.pdf', plot_mvpa_E1_FFA_2, width = 9, height = 8)
```
...
plot_mvpa_E1_FFA_3 <- {
  ggplot(data = one_mvpa_agg_E1_FFA, aes(y = mean, x = ClassifyPair, fill = ClassifyPair)) + # set the data, varialbes for x and y axises
    geom_col(position = "dodge", color = "black", alpha = .7, fill = "gray", show.legend = FALSE) +  # position of columns and countour of columns
    # scale_fill_grey() +
    facet_grid(. ~ Hemisphere) +
    # scale_fill_manual(values = mvpaColors) +
    geom_errorbar(mapping = aes(ymin = lower.CL, ymax = upper.CL), linetype = 1,  # set the error bar
...
ggsave('plot_mvpa_E1_FFA_3.pdf', plot_mvpa_E1_FFA_3, width = 9, height = 8)
```


#### Similarity of top + bottom to intact vs. exchange
##### One-sample t-test
```{r Similarity of top + bottom to intact vs. exchange in FFA E1}
...
##### Plot
```{r plot Similarity of top+bottom to intact vs. exchange in FFA, fig.asp=.5, fig.width = 13}
...
plot_simi_E1_FFA <- {
  ggplot(data = one_simi_E1_FFA, aes(y = mean, x = Combination, fill = Combination)) + # set the data, varialbes for x and y axises
    ...
    scale_y_continuous(expand= c(0, 0), limits = c(0, 1.1), breaks = seq(0, 1, .25)) +  # remove the space between columns and x axis
    # scale_x_discrete(labels = function(x) str_wrap(x, width = 10)) + # show x labels in two rows
    labs(title = "Similarity of top+bottom to intact vs. exchange in FFA", x = "Combinations", y = "Rate of Decoding as Exchange") +  # set the names for main, x and y axises
...
plot_simi_E1_FFA <- plot_simi(one_simi_E1_FFA, "FFA")
ggsave('plot_simi_E1_FFA.pdf', plot_simi_E1_FFA, width = 8, height = 10, units = "in")

```
The above figure shows the probability of top+bottom being decoded as exchange conditions in FFA. Patterns of top and bottom were combined with different weights, i.e., "face_top0.25-face_bottom0.75" denotes the linear combinations of face_top and face_bottom with the weights of 0.25/0.75. The numbers are the p-values for the two-tail one-sample t-tests against the chance level (0.5) in that condition. Error bars represent 95% confidence intervals.
...
ggsave('plot_simi_E1_FFA_1.pdf', plot_simi_E1_FFA_1, width = 14, height = 5)
...
ggsave('plot_simi_E1_FFA_2.pdf', plot_simi_E1_FFA_2, width = 10, height = 8)
...
plot_simi_E1_FFA_3 <- {
  ggplot(data = one_simi_E1_FFA, aes(y = mean, x = Combination, fill = Combination)) + # set the data, varialbes for x and y axises
    geom_col(position = "dodge", color = "black", fill = "gray", alpha = .7, show.legend = FALSE) +  # position of columns and countour of columns
    # scale_fill_grey() +
    facet_grid(. ~ Hemisphere) +
    geom_errorbar(mapping = aes(ymin = lower.CL, ymax = upper.CL), linetype = 1,  # set the error bar
                  show.legend = FALSE, width = 0.25, alpha = .5,
...
ggsave('plot_simi_E1_FFA_3.pdf', plot_simi_E1_FFA_3, width = 10, height = 8)
...
##### Plot
```{r plot Similarity of top+bottom to intact vs. exchange in FFA1, fig.asp=.5, fig.width = 13}
...
plot_simi_E1_FFA1 <- {
  ggplot(data = one_simi_E1_FFA1, aes(y = mean, x = Combination, fill = Combination)) + # set the data, varialbes for x and y axises
    ...
    scale_y_continuous(expand= c(0, 0), limits = c(0, 1.1), breaks = seq(0, 1, .25)) +  # remove the space between columns and x axis
    # scale_x_discrete(labels = function(x) str_wrap(x, width = 10)) + # show x labels in two rows
    labs(title = "Similarity of top+bottom to intact vs. exchange in FFA1", x = "Combinations", y = "Rate of Decoding as Exchange") +  # set the names for main, x and y axises
...
##### Plot
```{r plot Similarity of top+bottom to intact vs. exchange in FFA2, fig.asp=.5, fig.width = 13}
...
plot_simi_E1_FFA2 <- {
  ggplot(data = one_simi_E1_FFA2, aes(y = mean, x = Combination, fill = Combination)) + # set the data, varialbes for x and y axises
    ...
    scale_y_continuous(expand= c(0, 0), limits = c(0, 1.1), breaks = seq(0, 1, .25)) +  # remove the space between columns and x axis
    # scale_x_discrete(labels = function(x) str_wrap(x, width = 10)) + # show x labels in two rows
    labs(title = "Similarity of top+bottom to intact vs. exchange in FFA2", x = "Combinations", y = "Rate of Decoding as Exchange") +  # set the names for main, x and y axises
...
##### Plot
```{r plot Similarity of top+bottom to intact vs. exchange in VWFA, fig.asp=.5, fig.width = 11}
...
plot_simi_E1_VWFA <- {
  ggplot(data = one_simi_E1_VWFA, aes(y = mean, x = Combination, fill = Combination)) + # set the data, varialbes for x and y axises
    ...
    scale_y_continuous(expand= c(0, 0), limits = c(0, 1.1), breaks = seq(0, 1, .25)) +  # remove the space between columns and x axis
    # scale_x_discrete(labels = function(x) str_wrap(x, width = 10)) + # show x labels in two rows
    labs(title = "Similarity of top+bottom to intact vs. exchange in VWFA", x = "Combinations", y = "Rate of Decoding as Exchange") +  # set the names for main, x and y axises
...
plot_uni_E1_LOC
```
The above figure shows the neural respones (beta values) in LOC for each condition. The numbers are the p-values for the tests of differences between intact vs. exchange in that condition. Error bars represent 95% confidence intervals.
...
#### Similarity of top + bottom to intact vs. exchange
##### One-sample t-test
```{r Similarity of top + bottom to intact vs. exchange in LOC E1}
# Similarity of top + bottom to intact vs. exchange in LOC
one_simi_E1_LOC <- {
  df_simi_rate_E1_LOC %>% 
    group_by(Hemisphere, Combination) %>% 
    summarize(mean = t.test(RateAsExchange, mu = 0.5)[[5]],
...
##### Plot
```{r plot Similarity of top+bottom to intact vs. exchange in LOC, fig.asp=.5, fig.width = 13}
...
plot_simi_E1_LOC <- {
  ggplot(data = one_simi_E1_LOC, aes(y = mean, x = Combination, fill = Combination)) + # set the data, varialbes for x and y axises
    ...
    scale_y_continuous(expand= c(0, 0), limits = c(0, 1.1), breaks = seq(0, 1, .25)) +  # remove the space between columns and x axis
    # scale_x_discrete(labels = function(x) str_wrap(x, width = 10)) + # show x labels in two rows
    labs(title = "Similarity of top+bottom to intact vs. exchange in LOC", x = "Combinations", y = "Rate of Decoding as Exchange") +  # set the names for main, x and y axises
...
plot_simi_E1_LOC
```
The above figure shows the probability of top+bottom being decoded as exchange conditions in LOC. Patterns of top and bottom were combined with different weights, i.e., "face_top0.25-face_bottom0.75" denotes the linear combinations of face_top and face_bottom with the weights of 0.25/0.75. The numbers are the p-values for the two-tail one-sample t-tests against the chance level (0.5) in that condition. Error bars represent 95% confidence intervals.
...
plot_uni(desp_uni_E2_FFA, contr_anova_E2_lFFA, contr_anova_E2_rFFA, "FFA")
```
The above figure shows the neural respones (beta values) in FFA for each condition. The numbers are the p-values for the tests of differences between intact vs. exchange in that condition. Error bars represent 95% confidence intervals.
...
#### Similarity of top + bottom to intact vs. exchange
##### One-sample t-test
```{r Similarity of top + bottom to intact vs. exchange in FFA E2}
# Similarity of top + bottom to intact vs. exchange in FFA
one_simi_E2_FFA <- {
  df_simi_rate_E2_FFA %>% 
    group_by(Hemisphere, Combination) %>% 
...
##### Plot
```{r plot Similarity of top+bottom to intact vs. exchange in FFA E2, fig.asp=.5, fig.width = 13}
...
plot_simi_E2_FFA
```
The above figure shows the probability of top+bottom being decoded as exchange conditions in FFA. Patterns of top and bottom were combined with different weights, i.e., "Chinese_top0.25-Chinese_bottom0.75" denotes the linear combinations of Chinese_top and Chinese_bottom with the weights of 0.25/0.75. The numbers are the p-values for the two-tail one-sample t-tests against the chance level (0.5) in that condition. Error bars represent 95% confidence intervals.
...
# Similarity of top + bottom to intact vs. exchange in FFA1
one_simi_E2_FFA1 <- {
...
##### Plot
```{r plot Similarity of top+bottom to intact vs. exchange in FFA1 E2, fig.asp=.5, fig.width = 13}
...
plot_simi_E2_FFA1
```
The above figure shows the probability of top+bottom being decoded as exchange conditions in FFA1. Patterns of top and bottom were combined with different weights, i.e., "Chinese_top0.25-Chinese_bottom0.75" denotes the linear combinations of Chinese_top and Chinese_bottom with the weights of 0.25/0.75. The numbers are the p-values for the two-tail one-sample t-tests against the chance level (0.5) in that condition. Error bars represent 95% confidence intervals.
...
# Similarity of top + bottom to intact vs. exchange in FFA2
one_simi_E2_FFA2 <- {
...
##### Plot
```{r plot Similarity of top+bottom to intact vs. exchange in FFA2 E2, fig.asp=.5, fig.width = 13}
...
plot_simi_E2_FFA2
```
The above figure shows the probability of top+bottom being decoded as exchange conditions in FFA2. Patterns of top and bottom were combined with different weights, i.e., "Chinese_top0.25-Chinese_bottom0.75" denotes the linear combinations of Chinese_top and Chinese_bottom with the weights of 0.25/0.75. The numbers are the p-values for the two-tail one-sample t-tests against the chance level (0.5) in that condition. Error bars represent 95% confidence intervals.
...
##### Plot
```{r plot Similarity of top+bottom to intact vs. exchange in VWFA E2, fig.asp=.5, fig.width = 11}
...
#### Similarity of top + bottom to intact vs. exchange
##### One-sample t-test
```{r Similarity of top + bottom to intact vs. exchange in LOC E2}
# Similarity of top + bottom to intact vs. exchange in LOC
one_simi_E2_LOC <- {
  df_simi_rate_E2_LOC %>% 
    group_by(Hemisphere, Combination) %>% 
...
##### Plot
```{r plot Similarity of top+bottom to intact vs. exchange in LOC E2, fig.asp=.5, fig.width = 13}
...
plot_simi_E2_LOC
```
The above figure shows the probability of top+bottom being decoded as exchange conditions in LOC. Patterns of top and bottom were combined with different weights, i.e., "Chinese_top0.25-Chinese_bottom0.75" denotes the linear combinations of Chinese_top and Chinese_bottom with the weights of 0.25/0.75. The numbers are the p-values for the two-tail one-sample t-tests against the chance level (0.5) in that condition. Error bars represent 95% confidence intervals.
