...
3. The trained model is used to predict the condition of the combined pattern for each run separately. 
    + Mark as 1 if the combination is predicted as misconfigued;
    + Mark as 0 if the combination is predicted as intact.
4. The probability is calcualted by averaging all the predictions (1 or 0).
